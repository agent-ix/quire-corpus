...
| FR-003 | FR-003-AC-1, FR-003-AC-2, FR-003-AC-3, FR-003-AC-4, FR-003-AC-5 | TC-016, TC-017, TC-018, TC-019, TC-058, TC-061 | 🚧 Planned |
...
| FR-007 | FR-007-AC-1, FR-007-AC-2, FR-007-AC-3, FR-007-AC-4, FR-007-AC-5, FR-007-AC-6, FR-007-CON-1, FR-007-CON-2 | TC-047, TC-049, TC-050, TC-051, TC-052, TC-053, TC-054, TC-055 | 🚧 Planned |
...
| NFR-003 | NFR-003-AC-1, NFR-003-AC-2, NFR-003-AC-3, NFR-003-AC-4, NFR-003-AC-5, NFR-003-AC-6 | TC-048, TC-056, TC-057, TC-058, TC-059, TC-060 | 🚧 Planned |
| StR-001 | StR-001-VC-1, StR-001-VC-2, StR-001-VC-3, StR-001-VC-4 | TC-001, TC-002, TC-003, TC-004, TC-024, TC-030 | ✅ |
| StR-002 | StR-002-VC-1, StR-002-VC-2, StR-002-VC-3 | TC-047, TC-048, TC-049 | 🚧 Planned |
...
| TC-047 | one Rust library owns every corpus behavior behind the CLI | Compile | StR-002-VC-1, FR-007-AC-1 | 🚧 Planned |
| TC-048 | frozen Python and candidate Rust observations agree over the committed corpus before Python removal | Integration | StR-002-VC-2, NFR-003-AC-4 | 🚧 Planned |
| TC-049 | the port changes no source-language fixture input and never interprets it inside the corpus tool | Inspection | StR-002-VC-3, FR-007-CON-1 | 🚧 Planned |
| TC-050 | all five CLI subcommands operate from an explicit repository root | Integration | FR-007-AC-2 | 🚧 Planned |
| TC-051 | bounds, digest and score JSON output is deterministic | Integration | FR-007-AC-3 | 🚧 Planned |
| TC-052 | every rejected input exits non-zero with context and no success-shaped observation | Integration | FR-007-AC-4 | 🚧 Planned |
| TC-053 | criteria refresh derives one deterministic pin from the producer remote and exact revision | Integration | FR-007-AC-5 | 🚧 Planned |
| TC-054 | coverage validation rejects every false-green class named by the contract | Unit | FR-007-AC-6 | 🚧 Planned |
| TC-055 | Make contains orchestration only and no corpus assertion implementation | Static | FR-007-CON-2 | 🚧 Planned |
| TC-056 | exact Rust 1.98.1 and locked local commands resist selector mutations | Static | NFR-003-AC-1 | 🚧 Planned |
| TC-057 | producer execution cannot spawn a shell | Integration | NFR-003-AC-2, FR-003-CON-2 | 🚧 Planned |
| TC-058 | producer arguments with spaces, metacharacters and placeholder-looking text remain literal | Integration | NFR-003-AC-3, FR-003-AC-1 | 🚧 Planned |
| TC-059 | every implemented matrix row has a canonical `ix-trace-rs` test binding | Static | NFR-003-AC-5 | 🚧 Planned |
| TC-060 | the locked Rust graph passes license and advisory review | Static | NFR-003-AC-6 | 🚧 Planned |
| TC-061 | contract version 2 records structured invocation identity and refuses compatibility with version 1 | Integration | FR-003-AC-5 | 🚧 Planned |
